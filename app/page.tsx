...
const nearby = [
  {
    ...
    distance: "About 4 minutes by car",
  ...
  },
  {
    ...
    distance: "About 25 minutes by car",
  ...
  },
  {
    ...
    title: "Nearby boat rentals",
    distance: "About 5 minutes by car",
    text: "Rent a boat or paddling equipment nearby, then explore Canal Lake and the connected Trent–Severn Waterway.",
    href: "https://www.explorekawarthalakes.com/things-to-do/boating/",
    icon: "/icons/flaticon/waterfront.png",
    visual: "waterway",
  ...
  },
  {
    ...
    distance: "About 60 minutes by car",
  ...
  return (
    <main>
      ...
      <section className="explore section reveal" id="explore">
        ...
        <p className="distance-note">Travel times are approximate and can vary with traffic and the selected operator. Check current hours, rental availability, fees, operating dates and conditions before visiting.</p>
      </section>
      ...
      <section className="booking-section reveal" id="book">
        ...
        <div className="booking-copy">
          ...
          <div className="pricing-guide" aria-label="Nightly rates and cleaning fee">
            <p><span>Monday–Thursday</span><strong>$550 <small>per night</small></strong></p>
            <p><span>Friday–Sunday</span><strong>$600 <small>per night</small></strong></p>
            <p><span>Long weekends</span><strong>$650 <small>per night</small></strong></p>
            <p><span>Cleaning fee</span><strong>$200 <small>per stay</small></strong></p>
            <small className="pricing-note">Rates are in CAD before applicable taxes. The host confirms long-weekend pricing and the final total.</small>
          </div>
        </div>
        <BookingPanel
          variant="footer"
          pricing={bookingPricing}
          blockedDates={airbnbAvailability.blockedDates}
          availabilityStatus={airbnbAvailability.status}
          availabilityThrough={airbnbAvailability.availabilityThrough}
          availabilitySyncedAt={airbnbAvailability.syncedAt}
        />
        <p className="booking-disclosure"><strong className="licence-badge">Kawartha Lakes Short-Term Rental Licence STR2026-163</strong>Availability is refreshed automatically. Select your dates, then send the host a request without leaving the website. The exact arrival address and access instructions are sent privately after the host accepts the reservation.</p>
      </section>
