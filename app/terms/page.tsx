  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-content">
        ...
        <h1>Terms.</h1>
        <p className="legal-lede">These basic terms explain how to use this informational website. Last updated July 25, 2026.</p>
        ...
        <h2>Bookings</h2>
        <p>This website accepts stay requests but does not create a confirmed reservation or process payment. The availability calendar is read-only and is intended as a convenience. Guests should confirm dates, price, taxes, cancellation terms and final booking details with the host before travelling.</p>
        ...
        <h2>Licence and booking requirements</h2>
        <p>Lakefront Serenity operates under City of Kawartha Lakes Short-Term Rental Licence <strong>STR2026-163</strong>. Before accepting a direct reservation, the host should also maintain applicable insurance, tax registration and collection obligations, a written rental agreement, cancellation terms, any deposit or damage authorization, and final arrival instructions.</p>
        ...
        <ul>
          ...
          <li>The property is near a lake and other bodies of water.</li>
          <li>Carbon monoxide and smoke alarms are installed.</li>
