...
import { BookingEmailComposer } from "./BookingEmailComposer";
...
export function MobileBookingFlow({ pricing, blockedDates }: MobileBookingFlowProps) {
  ...
  async function submitRequest() {
    ...
    try {
      ...
      setRequestId(body.id || ""); setRequestSaved(response.ok); setSubmitted(true); setComposerOpen(true);
      ...
      setSubmitted(true); setComposerOpen(true);
